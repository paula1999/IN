...
rf = RandomForestClassifier(n_jobs=-1, n_estimators=600, max_depth=15, max_features="sqrt", random_state=123456)
...
df_submission.to_csv("submission_ejemplo_flu_02.csv", index=False)
