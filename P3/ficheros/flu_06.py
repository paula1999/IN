...
lgbm = LGBMClassifier(num_leaves=20, learning_rate=0.1, n_estimators=1000, min_child_samples=30, colsample_bytree=0.3, reg_alpha=8, reg_lambda=8)
# Multioutput classifier, para indicar que tiene que aprender varias etiquetas a la vez
multi = MultiOutputClassifier(lgbm)
...
df_submission.to_csv("submission_ejemplo_flu_06.csv", index=False)
