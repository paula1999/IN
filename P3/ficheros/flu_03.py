...
ab = AdaBoostClassifier(n_estimators=600, learning_rate=0.5, random_state=123456)
# Multioutput classifier, para indicar que tiene que aprender varias etiquetas a la vez
multi = MultiOutputClassifier(ab)
...
df_submission.to_csv("submission_ejemplo_flu_03.csv", index=False)
