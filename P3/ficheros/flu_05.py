...
skf = KFold(n_splits=15, shuffle=True, random_state=123456)
...
gb = GradientBoostingClassifier(n_estimators=300, criterion="squared_error", random_state=123456) # 0.8670
# Multioutput classifier, para indicar que tiene que aprender varias etiquetas a la vez
multi = MultiOutputClassifier(gb)
...
df_submission.to_csv("submission_ejemplo_flu_05.csv", index=False)
